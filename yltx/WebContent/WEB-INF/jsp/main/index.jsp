...
<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden;">
    <div id="ajax-loader" style="cursor: progress; position: fixed; top: -50%; left: -50%; width: 200%; height: 200%; background: #fff; z-index: 10000; overflow: hidden;">
        <img src="${pageContext.request.contextPath }/resources/img/ajax-loader.gif" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; margin: auto;" />
    </div>
    <div class="wrapper">
        <!--头部信息-->
        ...
        <div id="content-wrapper" class="content-wrapper">
            <div class="content-tabs">
                ...
                <nav class="page-tabs menuTabs">
                    <div class="page-tabs-content" style="margin-left: 0px;">
                        ...
                        <a href="javascript:;" class="menuTab" data-id="${pageContext.request.contextPath }/sys/user/list">用户管理 <i class="fa fa-remove"></i></a>
                    </div>
                </nav>
            ...
            <div class="content-iframe" style="overflow: hidden;">
                <div class="mainContent" id="content-main" style="margin: 10px; margin-bottom: 0px; padding: 0;">
                    <iframe class="LRADMS_iframe" width="100%" height="100%" src="${pageContext.request.contextPath }/sys/default" frameborder="0" data-id="${pageContext.request.contextPath }/sys/user/list"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
    	$(function () {
            ...
            // 异步加载菜单信息
            $.ajax({
            	url: '${pageContext.request.contextPath }/sys/menu',
            	type: 'POST',
