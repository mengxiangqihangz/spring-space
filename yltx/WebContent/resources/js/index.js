            ...
            if (!$(this).hasClass('active')) {
                $('.mainContent .LRADMS_iframe').each(function () {
                    ...
                    if ($(this).data('id') == currentId) {
                        ...
                        $('.LRADMS_iframe').attr("src",currentId);
                        return false;
                    }
                });
        ...
        loadMenu: function (data) {
            ...
            $.each(data, function (i) {
                ...
                if (row.parentMenuId == "0") {
                    ...
                    _html += '<a href="#">'
                    _html += '<i class="' + row.F_Icon + '"></i><span>' + row.menuName + '</span><i class="fa fa-angle-left pull-right"></i>'
                    _html += '</a>'
                    ...
                    if (childNodes.length > 0) {
                        ...
                        $.each(childNodes, function (i) {
                            ...
                            if (subchildNodes.length > 0) {
                                _html += '<a href="#"><i class="' + subrow.F_Icon + '"></i>' + subrow.menuName + '';
                                _html += '<i class="fa fa-angle-left pull-right"></i></a>';
                                _html += '<ul class="treeview-menu">';
                                $.each(subchildNodes, function (i) {
                                    var subchildNodesrow = subchildNodes[i];
                                    _html += '<li><a class="menuItem" data-id="' + subrow.menuId + '" href="' + subrow.menuPath + '"><i class="' + subchildNodesrow.F_Icon + '"></i>' + subchildNodesrow.menuName + '</a></li>';
                                });
                                _html += '</ul>';

                            } else {
                                _html += '<a class="menuItem" data-id="' + subrow.menuId + '" href="' + subrow.menuPath + '"><i class="' + subrow.F_Icon + '"></i>' + subrow.menuName + '</a>';
                            }
                            _html += '</li>';
                        });
                        _html += '</ul>';
