...
public class ConnectionFactory {
	...
	public Connection getConnection(String type) throws Exception{
		if(type.equalsIgnoreCase("mysql")){
			path="D:/workspace/defineMVC/src/com/zdy/cn/connection/mysql.properties";
		}else if(type.equalsIgnoreCase("oracle")){
			path="D:/workspace/defineMVC/src/com/zdy/cn/connection/oracle.properties";
		}else{
			return null;
		}
