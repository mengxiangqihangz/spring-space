...
<html lang="en">
	<head>
		...
		<!-- <![endif]-->
		<!--[if IE]>
         <script type="text/javascript">window.jQuery || document.write("<script src='${pageContext.request.contextPath}/resources/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
        <![endif]-->
		...
		<script src="${pageContext.request.contextPath}/resources/assets/laydate/laydate.js" type="text/javascript"></script>
...
$('.change_Password').on('click', function(){
  ...
  $('#Exit_system').on('click', function(){
	...
	function(){
	  location.href="${pageContext.request.contextPath}/sys/login";
               ...
               <ul class="nav ace-nav">	
                <li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<span  class="time"><em id="time"></em></span><span class="user-info"><small>欢迎光临,</small>${sysUser.getUserName()}	</span>
								<i class="icon-caret-down"></i>
							</a>
							<ul class="user-menu pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
								<li><a href="#"><i class="icon-cog"></i>设置</a></li>
								<li><a href="${pageContext.request.contextPath }/admin/info"><i class="icon-user"></i>个人资料</a></li>
								<li class="divider"></li>
			...
			<div class="main-container-inner">
				...
				<script type="text/javascript">
					...
					<ul class="nav nav-list" id="nav_list">
				     <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/sys/home?userId=${sysUser.getUserId()}" class="iframeurl" title=""><i class="icon-dashboard"></i><span class="menu-text"> 系统首页 </span></a></li>
                     <li><a href="#" class="dropdown-toggle"><i class="icon-desktop"></i><span class="menu-text"> 产品管理 </span><b class="arrow icon-angle-down"></b></a>
					   <ul class="submenu">
                         <li class="home"><a  href="javascript:void(0)" name="${pageContext.request.contextPath }/product/list"  title="产品类表" class="iframeurl"><i class="icon-double-angle-right"></i>产品类表</a></li>
                    ...
                    <ul class="submenu">
                    <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/transaction/transaction" title="交易信息"  class="iframeurl"><i class="icon-double-angle-right"></i>交易信息</a></li>
                    <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/transaction/orderform" title="订单管理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单管理</a></li>
                    <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/transaction/amounts" title="交易金额"  class="iframeurl"><i class="icon-double-angle-right"></i>交易金额</a></li>
                    <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/transaction/orderhandling" title="订单处理"  class="iframeurl"><i class="icon-double-angle-right"></i>订单处理</a></li>
                    <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/transaction/covermanagement" title="支付管理"  class="iframeurl"><i class="icon-double-angle-right"></i>支付管理</a></li>
                   </ul>
				  </li>
                  <li>
                    ...
                    <li class="home"><a href="javascript:void(0)" name="integration.html" title="会员记录管理"  class="iframeurl"><i class="icon-double-angle-right"></i>会员记录管理</a></li>
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 管理员管理 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
								...
								<li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/admin/competence?userId=${sysUser.getUserId()}" title="权限管理"  class="iframeurl"><i class="icon-double-angle-right"></i>权限管理</a></li>
                                <li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/admin/admin?userId=${sysUser.getUserId()}" title="管理员列表" class="iframeurl"><i class="icon-double-angle-right"></i>管理员列表</a></li>
								<li class="home"><a href="javascript:void(0)" name="${pageContext.request.contextPath }/admin/info?userId=${sysUser.getUserId()}" title="个人信息" class="iframeurl"><i class="icon-double-angle-right"></i>个人信息</a></li>
							</ul>
						</li>
					</ul>
                ...
                <script type="text/javascript">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						<ul class="breadcrumb">
							<li>
								...
								<a href="${pageContext.request.contextPath }/sys/home?userId=${sysUser.getUserId()}">首页</a>
							</li>
                 ...
                 <iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="${pageContext.request.contextPath}/sys/home?userId=${sysUser.getUserId()}">  </iframe>
...
<!-- /.page-content -->
         ...
         <div class="footer_style" id="footerstyle">  
          <p class="l_f">版权所有：深圳云联天下  粤ICP备11011739号</p>
          <p class="r_f">地址：深圳市龙华新区和平路港之龙C座902室  邮编：518109 技术支持：XXXX</p>
         </div>
         <!--修改密码样式-->
