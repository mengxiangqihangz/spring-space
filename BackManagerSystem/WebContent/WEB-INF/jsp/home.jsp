...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<!-- <![endif]-->
           	<script src="${pageContext.request.contextPath}/resources/assets/dist/echarts.js"></script>
...
<div class="page-content clearfix">
 <div class="alert alert-block alert-success">	
  ...
  <i class="icon-ok green"></i>欢迎使用<strong class="green">云联天下后台管理系统<small>(v1.2)</small></strong>,你本次登陆时间为${loginRecords.getLoadTime()}，登陆IP: &nbsp;${loginRecords.getIP() }.	
 </div>
...
<script type="text/javascript">
    ...
    $(window).resize(function(){
        ...
        require.config({
            paths: {
                echarts: '${pageContext.request.contextPath}/resources/assets/dist'
            }
        });
        require(
            [
