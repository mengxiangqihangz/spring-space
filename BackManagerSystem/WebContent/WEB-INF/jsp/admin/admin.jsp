...
<meta http-equiv="Cache-Control" content="no-siteapp" />
        ...
        <link href="${pageContext.request.contextPath}/resources/assets/css/codemirror.css" rel="stylesheet">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/assets/css/ace.min.css" />
        <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/font/css/font-awesome.min.css" />
        <!--[if lte IE 8]>
        ...
        <script type="text/javascript" src="${pageContext.request.contextPath}/resources/Widget/Validform/5.3.2/Validform.min.js"></script>
		...
		<script src="${pageContext.request.contextPath}/resources/js/lrtk.js" type="text/javascript" ></script>
        <script src="${pageContext.request.contextPath}/resources/assets/layer/layer.js" type="text/javascript"></script>	
